...
namespace TicketThijsMateo.Repositories
{
    public class StadiumIDAO : IDAO<Stadium>
    {
        ...
        public Task<IEnumerable<Stadium>?> GetAllByWedstrijdId(int Id)
        {
            throw new NotImplementedException();
        }

        public Task<IEnumerable<Stadium>?> FindByZitplaatsIdAsync(int Id)
        {
            throw new NotImplementedException();
        }

        Task<Stadium?> IDAO<Stadium>.FindByZitplaatsIdAsync(int Id)
        {
            throw new NotImplementedException();
        }
    }
